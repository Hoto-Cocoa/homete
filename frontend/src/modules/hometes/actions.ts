...
export const FETCH_ONE = "hometes/FETCH_ONE" as const;
export const FETCH_ONE_SUCCESS = "hometes/FETCH_ONE_SUCCESS" as const;
export const FETCH_ONE_FAILURE = "hometes/FETCH_ONE_FAILURE" as const;
...
export const fetchOneAsync = createAsyncAction(
  FETCH_ONE,
  FETCH_ONE_SUCCESS,
  FETCH_ONE_FAILURE,
)<string, Homete, Error>();
